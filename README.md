...
I thrive on tackling complex problems and enjoy the entire lifecycle of ML projects - from data collection and preprocessing to model deployment and monitoring. When I'm not coding, you'll find me exploring new ML research papers, contributing to open-source projects, or sharing knowledge with the community. I believe in continuous learning and staying at the forefront of AI advancements.
...
### Languages & Tools
<p align="left">
  <img src="https://skillicons.dev/icons?i=python,tensorflow,pytorch,aws,docker,git,linux,mysql,react,nodejs" />
</p>
...
<a href="https://kaggle.com/m-alitahir" target="_blank">
  <img src="https://img.shields.io/badge/Kaggle-20BEFF?style=for-the-badge&logo=kaggle&logoColor=white" />
</a>
<a href="https://twitter.com/m-alitahir" target="_blank">
...
class MachineLearningEngineer:
    ...
    def collaborate_on(self):
        return ["ML Research", "Open Source", "Data Engineering"]
    
    def seeking_help_with(self):
        return ["Scalable ML Systems", "Model Optimization", "Production Deployment"]
